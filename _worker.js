    ...
    const output = userIDArray.map((userID) => {
        ...
        return `
            <div class="config-item">
                <h2>UUID: ${userID}</h2>
                <div class="separator">${hashSeparator}</div>
<h3>v2ray default ip</h3>
                <pre>${วเลสMain}</pre>
                <button onclick='copyToClipboard("${วเลสMain}")'>
                    <i class="fa fa-clipboard"></i> Copy วเลสMain
                </button>
                <h3>v2ray with bestip</h3>
                <pre>${วเลสSec}</pre>
                <button onclick='copyToClipboard("${วเลสSec}")'>
    ...
    <head>
        ...
        <meta name="keywords" content="EDtunnel, cloudflare pages, cloudflare worker, serverless">
        ...
        <meta property="og:description" content="Use cloudflare pages and worker serverless to implement วเลส protocol" />
        ...
        <meta name="twitter:description" content="Use cloudflare pages and worker serverless to implement วเลส protocol" />
    ...
    <body>
        <div class="container">
            ...
            <p>Welcome! This function generates configuration for vless protocol. If you found this useful, please check our GitHub project:</p>
            ...
            <div class="links">
                ...
                <a href="v2rayng://install-config?url=${encodeURIComponent(subbestip)}" target="_blank">v2rayNG优选IP自动</a>
            </div>
        </div>
        <script>
